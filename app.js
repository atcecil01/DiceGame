...
//Load Dice elements into variables
...
die1.addEventListener("click", function() {
    if (d1frozen === false) {
        d1frozen = true;
        die1.style.border = "4px solid Red";
    } else {
        d1frozen = false;
        die1.style.border = "";
    }
...
die2.addEventListener("click", function() {
    if (d2frozen === false) {
        d2frozen = true;
        die2.style.border = "4px solid Red";
    } else {
        d2frozen = false;
        die2.style.border = "";
    }
...
die3.addEventListener("click", function() {
    if (d3frozen === false) {
        d3frozen = true;
        die3.style.border = "4px solid Red";
    } else {
        d3frozen = false;
        die3.style.border = "";
    }
...
die4.addEventListener("click", function() {
    if (d4frozen === false) {
        d4frozen = true;
        die4.style.border = "4px solid Red";
    } else {
        d4frozen = false;
        die4.style.border = "";
    }
...
die5.addEventListener("click", function() {
    if (d5frozen === false) {
        d5frozen = true;
        die5.style.border = "4px solid Red";
    } else {
        d5frozen = false;
        die5.style.border = "";
    }
...
rollButton.addEventListener("click", function() {
    ...
    if (parseInt(roll1) === 1) {
        die1.setAttribute("src", "img/die1.jpg");
        die1.setAttribute("alt", "one")
    } else if (parseInt(roll1) === 2) {
        die1.setAttribute("src", "img/die2.jpg");
        die1.setAttribute("alt", "two");
    } else if (parseInt(roll1) === 3) {
        die1.setAttribute("src", "img/die3.jpg");
        die1.setAttribute("alt", "three")
    } else if (parseInt(roll1) === 4) {
        die1.setAttribute("src", "img/die4.jpg");
        die1.setAttribute("alt", "four")
    } else if (parseInt(roll1) === 5) {
        die1.setAttribute("src", "img/die5.jpg");
        die1.setAttribute("alt", "five")
    } else {
        die1.setAttribute("src", "img/die6.jpg");
        die1.setAttribute("alt", "six")
    }

    //Die 2 image selection
    if (parseInt(roll2) === 1) {
        die2.setAttribute("src", "img/die1.jpg");
        die2.setAttribute("alt", "one")
    } else if (parseInt(roll2) === 2) {
        die2.setAttribute("src", "img/die2.jpg");
        die2.setAttribute("alt", "two")
    } else if (parseInt(roll2) === 3) {
        die2.setAttribute("src", "img/die3.jpg");
        die2.setAttribute("alt", "three")
    } else if (parseInt(roll2) === 4) {
        die2.setAttribute("src", "img/die4.jpg");
        die2.setAttribute("alt", "four")
    } else if (parseInt(roll2) === 5) {
        die2.setAttribute("src", "img/die5.jpg");
        die2.setAttribute("alt", "five")
    } else {
        die2.setAttribute("src", "img/die6.jpg");
        die2.setAttribute("alt", "six")
    }
    //Die 3 image selection
    if (parseInt(roll3) === 1) {
        die3.setAttribute("src", "img/die1.jpg");
        die3.setAttribute("alt", "one")
    } else if (parseInt(roll3) === 2) {
        die3.setAttribute("src", "img/die2.jpg");
        die3.setAttribute("alt", "two")
    } else if (parseInt(roll3) === 3) {
        die3.setAttribute("src", "img/die3.jpg");
        die3.setAttribute("alt", "three")
    } else if (parseInt(roll3) === 4) {
        die3.setAttribute("src", "img/die4.jpg");
        die3.setAttribute("alt", "four")
    } else if (parseInt(roll3) === 5) {
        die3.setAttribute("src", "img/die5.jpg");
        die3.setAttribute("alt", "five")
    } else {
        die3.setAttribute("src", "img/die6.jpg");
        die3.setAttribute("alt", "six")
    }
    //Die 4 image selection
    if (parseInt(roll4) === 1) {
        die4.setAttribute("src", "img/die1.jpg");
        die4.setAttribute("alt", "one")
    } else if (parseInt(roll4) === 2) {
        die4.setAttribute("src", "img/die2.jpg");
        die4.setAttribute("alt", "two")
    } else if (parseInt(roll4) === 3) {
        die4.setAttribute("src", "img/die3.jpg");
        die4.setAttribute("alt", "three")
    } else if (parseInt(roll4) === 4) {
        die4.setAttribute("src", "img/die4.jpg");
        die4.setAttribute("alt", "four")
    } else if (parseInt(roll4) === 5) {
        die4.setAttribute("src", "img/die5.jpg");
        die4.setAttribute("alt", "five")
    } else {
        die4.setAttribute("src", "img/die6.jpg");
        die4.setAttribute("alt", "six")
    }
    //Die 5 image selection
    if (parseInt(roll5) === 1) {
        die5.setAttribute("src", "img/die1.jpg");
        die5.setAttribute("alt", "one")
    } else if (parseInt(roll5) === 2) {
        die5.setAttribute("src", "img/die2.jpg");
        die5.setAttribute("alt", "two")
    } else if (parseInt(roll5) === 3) {
        die5.setAttribute("src", "img/die3.jpg");
        die5.setAttribute("alt", "three")
    } else if (parseInt(roll5) === 4) {
        die5.setAttribute("src", "img/die4.jpg");
        die5.setAttribute("alt", "four")
    } else if (parseInt(roll5) === 5) {
        die5.setAttribute("src", "img/die5.jpg");
        die5.setAttribute("alt", "five")
    } else {
        die5.setAttribute("src", "img/die6.jpg");
        die5.setAttribute("alt", "six")
    }
});
